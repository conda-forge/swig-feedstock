...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/swig-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/swig-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add swig swig-abi
# for installing globally
pixi global install swig swig-abi
```
...
It is possible to list all of the versions of `swig` available on your platform:
...
```
pixi search swig --channel conda-forge
```
